            ...
            <div class="layout-px-spacing">
                ...
                <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-one">
                        <div class="row">
                            <div class="col">
                                <div class="widget-heading col-lg-8">
                                    <h6 class="">Availabe Life Packs</h6>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <a href="lifepackadd.php"><button id="lpAdd"  class="btn mb-2 float-right" style="background-color: #f49617;color: aliceblue;">Add Life Pack</button>
                          </a>
                            </div>
                        </div>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Life Pack</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="container">
                                            <form class="form-vertical" method="POST" id="lifepackForm1">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="checkbox-inline"><input type="checkbox" value="" class="mr-2" >Open</label>
                                                        <label class="checkbox-inline"><input type="checkbox" value="" class="mr-2" >Private</label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" id="lpAddBtn"
                        ...
                        <div class="row">
                            <div class="container">
                                <ul class="list-group list-group-icons-meta lifepacks" id="lifepackList">
