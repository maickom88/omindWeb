								...
								<form class="form-vertical " id="lifepackQuestionForm1" method="POST">
									...
									<div class="form-group">
										...
										<select class="form-control" id="exampleFormControlSelect1" name="option">
											...
											<option value="Image Type Question">Image Type Question</option>
											<option value="Timer Question">Timer Question</option>
											<option value="Range Slider Question">Range Slider Question</option>
											<option value="Audio Type Question">Audio Type Question</option>
										</select>
