            ...
            <div class="layout-px-spacing">
                ...
                <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-one">
                        ...
                        <div class="row">
                            <div class="container">
                            <form class="form-vertical" id="lifepackQuestionForm1" method="POST">
                          ...
                          <label for="exampleFormControlSelect1">select the type of Question</label>
    <select class="form-control" id="exampleFormControlSelect1">
      <option>Mcq Questions</option>
      <option>Image Type Question</option>
      <option>Timer Question</option>
      <option>Range Slider Question</option>
      <option>Audio Type Question</option>
    </select>
    <button class="btn mt-4 float-right" id="lifepack-btn" style="background-color: #f49617;color: aliceblue;">Next</button>
                          </div>
